...
public class ArrayNotes {
    public static void main(String[] args) {
        ...
        */ 
        ...
        // position 7?
        //System.out.println(temps[7]);    // error - ArrayIndexOutOfBounds
   ...
   // Note: if you send an array as a parameter to a method, and you change the array inside the method, then the changes will "stick" when the method is done
